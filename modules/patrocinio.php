<!-- Header Banner -->
<header class="banner-header valign bg-img bg-img-fixed" data-overlay-dark="5" data-background="/img/banner/04.jpg">
    <div class="container">
        <div class="row">
                    ...
                    <div class="cont">
                        ...
                        <p>
                            ...
                            * Marca al inicio en cortometraje, comerciales del evento, playera
                            de chefs, redes sociales, radio, restaurantes, centros
                            comerciales, Marina, eventos gastronómicos y rueda de prensa.<br>
                            * +600,000 impactos en 3 meses.<br>
                            * Un espacio de stand en evento de bienvenida de prensa y chefs.<br>
                            * Dos espacios de stands en evento principal.<br>
                            * Mesa para 10 pax en zona Dante (mitlan), valor 200 mil pesos.<br>
                            * 20 boletos VIP, valor 140 mil pesos.<br>
                            * 30 boletos generales, valor 105 mil pesos.<br>
                            * Marca en brazalete.<br>

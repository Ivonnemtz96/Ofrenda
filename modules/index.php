...
<header class="header slider-fade d-none d-md-none d-lg-block">
    <div class="owl-carousel owl-theme">
        ...
        <div class="text-left item bg-img" data-overlay-dark="1" data-background="/img/slider/slider2.jpg?=1">
            <div class="v-middle caption mt-30">
                <div class="container">
                    <div class="row">
                        <div class="col-md-8">
        ...
        <div class="text-left item bg-img" data-overlay-dark="1" data-background="/img/slider/slider3.jpg?=1">
            <div class="v-middle caption mt-30">
                <div class="container">
                    <div class="row">
                        <div class="col-md-8">

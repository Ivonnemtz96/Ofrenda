<!-- Header Banner -->
<header class="banner-header valign bg-img bg-img-fixed" data-overlay-dark="5" data-background="/img/banner/01.jpg?=1">
    <div class="container">
        <div class="row">
                ...
                <div class="about-frame">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="frame-img">
                                <div class="img mb-20">
                                    <img src="/img/03.jpg?=1" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-7">
                            <div class="frame-img">
                                <div class="img"> <img src="/img/04.jpg?=1" alt=""> </div>
                            </div>
                        </div>
                        <div class="col-md-5">
    ...
    <div class="container">
        <div class="row ">
            ...
            <div class="col-md-6 mb-60 animate-box" data-animate-effect="fadeInUp">
                ...
                <h2 class="section-title" style="text-transform: none;">¿Por qué en Los Cabos?</h2>
                <p>
                    Los Cabos expresa lo mejor de México a nivel mundial, donde convergen distintas culturas
                    gastronómicas
                    y se origina una tribu única que disfruta de los ingredientes locales.
                </p>
            </div>
        </div>
        <div class="row">
